      ...
      <aside style="border-right:2px solid var(--color-divider);padding:24px 20px">
        ...
        <div style="display:flex;flex-direction:column">
          <Link v-for="t in tabs" :key="t.label" :href="t.href()"
            style="text-align:left;min-height:44px;padding:10px 12px;border:0;border-bottom:1px solid var(--color-divider);cursor:pointer;font-family:var(--font-heading);font-weight:600;font-size:14px;text-decoration:none;display:flex;align-items:center"
