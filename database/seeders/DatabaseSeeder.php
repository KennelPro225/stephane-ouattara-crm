...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $programmes = collect([
            ['title' => 'Club des Champions — Niveau Lion', 'audience' => 'adolescents', 'type' => 'group', 'level' => 'Lion', 'price_amount' => 150000, 'price_label' => '150 000 FCFA', 'start_date' => '2026-10-05', 'end_date' => '2026-12-20', 'registration_deadline' => '2026-09-28', 'duration_label' => '12 semaines', 'ages_label' => '12 – 15 ans', 'max_participants' => 24, 'featured' => true, 'schedule_mode' => 'weekly', 'session_weekday' => 3, 'session_start_time' => '16:00', 'session_duration_minutes' => 120, 'description' => "Premier niveau du parcours d'excellence : confiance en soi, prise de parole et discipline personnelle."],
            ['title' => 'Club des Champions — Niveau Meute', 'audience' => 'adolescents', 'type' => 'group', 'level' => 'Meute', 'price_amount' => 180000, 'price_label' => '180 000 FCFA', 'start_date' => '2026-10-12', 'end_date' => '2027-01-31', 'registration_deadline' => '2026-10-03', 'duration_label' => '16 semaines', 'ages_label' => '14 – 17 ans', 'max_participants' => 20, 'featured' => false, 'schedule_mode' => 'weekly', 'session_weekday' => 4, 'session_start_time' => '16:00', 'session_duration_minutes' => 120, 'description' => 'Travail collectif, coopération et leadership partagé au sein du groupe.'],
            ...
            ['title' => 'Compétence 360', 'audience' => 'entreprises', 'type' => 'corporate', 'level' => 'Standard', 'price_amount' => null, 'price_label' => 'Sur devis', 'start_date' => '2026-11-02', 'end_date' => '2026-12-11', 'registration_deadline' => '2026-10-20', 'duration_label' => '6 modules', 'ages_label' => 'Adultes', 'max_participants' => 30, 'featured' => false, 'schedule_mode' => 'weekly_full_day', 'session_weekday' => 1, 'description' => 'Programme de montée en compétences 360° : posture, communication et performance collective.'],
            ['title' => 'La Connexion — Parents & Ados', 'audience' => 'adultes', 'type' => 'group', 'level' => 'Standard', 'price_amount' => 95000, 'price_label' => '95 000 FCFA', 'start_date' => '2026-10-03', 'end_date' => '2026-11-07', 'registration_deadline' => '2026-09-26', 'duration_label' => '6 séances', 'ages_label' => 'Parents', 'max_participants' => 25, 'featured' => true, 'schedule_mode' => 'weekly', 'session_weekday' => 6, 'session_start_time' => '10:00', 'session_duration_minutes' => 90, 'description' => 'Rétablir le dialogue entre parents et adolescents avec des outils concrets de communication.'],
